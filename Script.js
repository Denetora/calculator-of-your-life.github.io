jQuery("document").ready(function(){
	...
	var month1, month2, day1, day2, year1, year2, razn_year, vis_year, sum_year, kol_day;
...
var hour_work, vse_otpuska_hour, vse_otpuska, hour_work_21, kol_money_hour_life, kol_money_hour, kol_money_month, kol_money_hour, year_work, kol_day_work, kol_hour_work, kol_freedom_day, kol_freedom_hour, kol_sleep_sum, sleep_hour;
	...
	jQuery("#result3").html( kol_money_month );
	jQuery("#result4").html( kol_money_hour );
	jQuery("#result5").html( kol_money_hour_life );	
	jQuery("#result6").html( kol_day_work );
	jQuery("#result7").html( kol_hour_work );
	jQuery("#result8").html( kol_freedom_day_and_otpuska );
	jQuery("#result9").html( kol_freedom_hour );
